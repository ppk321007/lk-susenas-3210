export const NON_FOOD_DETAIL_CATEGORIES = {
  A: {
  ...
  B: {
    ...
    yearlyItems: [
      ...
      "Praktik petugas kesehatan (bidan/perawat/mantri kesehatan)",
      ...
      "Transportasi laut/kapal feri, kapal laut",
      "Lainnya (uang parkir, karcis tol, dsb.)",
  ...
  E: {
    ...
    yearlyItems: [
      ...
      "Pajak kendaraan bermotor (STNK) dan tak bermotor",
