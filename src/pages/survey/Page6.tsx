...
export const Page6 = ({
  ...
  const calculateKonsumsiRT = () => {
    // Calculate food subtotal (weekly) - same as Page4Recap
    ...
    // Food monthly average (same as Page4Recap line 84)
    const rataRataSebulan = foodSubtotal * 30 / 7;

    // Calculate RATA-RATA PENGELUARAN RUMAH TANGGA SEBULAN using exact same formula as Page4Recap (lines 344-370)
    ...
    // Return yearly consumption (multiply exact monthly average by 12)
    // Nilai = (kolom Sebulan Terakhir, tabel BLOK IV.3.3) * 12
